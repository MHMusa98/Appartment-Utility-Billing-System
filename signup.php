...
return true;
    ...
    <nav class="navbar fixed-top  navbar-expand navbar-dark bg-dark py-2">
            <!-- Navbar Brand-->
        ...
        <h1 class="card bg-warning text-dark ps-1" align="center"> Welcome To Dream Housing </h1>
...
<h2 align="center">Appartment Utility Billing System</h2>
<hr />
